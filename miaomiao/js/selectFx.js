...
SelectFx.prototype.options={newTab:true,stickyPlaceholder:true,onChange:function(val){ selectChange(val); return false;}}
...
var tmpcurrent=typeof this.preSelCurrent!='undefined'&&this.preSelCurrent!==-1?this.preSelCurrent:this.current;if(dir==='prev'&&tmpcurrent>0||dir==='next'&&tmpcurrent